package com.xinshei.a2dbarcodescanner;
...
import com.xinshei.a2dbarcodescanner.zxing.CustomScanActivity;
import com.xinshei.a2dbarcodescanner.zxing.RegexUtil;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (intentResult != null) {
            if (intentResult.getContents() == null) {
                ...
                try {
                    RegexUtil.jumper(this, uri);
                } catch (Exception e) {
                    Toast.makeText(this, "请安装信谁App", Toast.LENGTH_SHORT).show();
                }
            }
        } else {
